...
public class ForgingStationWindowSystem extends BaseComponentSystem {
    ...
    public void itemPutIntoInventorySlot(BeforeItemPutInInventory event, EntityRef entity,
        ...
        if (entity.getComponent(InteractionScreenComponent.class).screen.equalsIgnoreCase("EquipmentSmithing" +
                ":ForgingStation")) {
            ForgingStationWindow screen = (ForgingStationWindow) nuiManager.getScreen("EquipmentSmithing" +
                    ":ForgingStation");
