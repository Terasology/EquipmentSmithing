...
/**
 * This class is designed for handling certain events related to the ForgingStation UI.
 */
@RegisterSystem
public class ForgingStationWindowSystem extends BaseComponentSystem {
    @In
    ...
    public void itemPutIntoInventorySlot(BeforeItemPutInInventory event, EntityRef entity,
        ...
        if (entity.getComponent(InteractionScreenComponent.class).screen.equalsIgnoreCase("EquipmentSmithing:ForgingStation")) {
            ForgingStationWindow screen = (ForgingStationWindow) nuiManager.getScreen("EquipmentSmithing:ForgingStation");
