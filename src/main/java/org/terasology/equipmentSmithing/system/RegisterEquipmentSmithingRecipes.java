 ...
 */
@RegisterSystem
public class RegisterEquipmentSmithingRecipes extends BaseComponentSystem {
    @In
    ...
    public void initialise() {
        ...
        workstationRegistry.registerProcessFactory(EquipmentSmithing.FORGING_TIER_1_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(EquipmentSmithing.FORGING_TIER_2_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(EquipmentSmithing.FORGING_TIER_3_PROCESS,
                new CraftingWorkstationProcessFactory());
        //workstationRegistry.registerProcessFactory(EquipmentSmithing.FORGING_TIER_4_PROCESS, new 
